...
library(scales)
library(usmap) # for mapping; uses 2020 shapefiles!
...
# mapping using usmap
# plot_usmap() outputs a ggplot object so you can customize it further
# I make lines thinner too
plt <- plot_usmap(regions='counties', data=df, values='POPESTIMATE2021', size=0.01) +
...
# save
ggsave('usmap_mapping_plt.png', width=7, height=5, units='in', dpi=600) # png
ggsave('usmap_mapping_plt.pdf', width=7, height=5, units='in')
